...
const schema = joi.object().keys({
    ...
    spotInstances: joi.object({
        ...
        instanceTypes: joi.array().items(joi.string()),
        spotAllocationStrategy: joi.string().valid('capacity-optimized-prioritized', 'lowest-price', 'capacity-optimized', 'price-capacity-optimized'),
    ...
    yumPackages: joi.object().pattern(/[/s/S]*/, [joi.string().allow('')]),
